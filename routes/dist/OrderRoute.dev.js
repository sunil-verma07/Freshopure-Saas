...
router.get("/allHotelOrders", authMiddleware.authMiddleware, ordercontroller.allHotelOrders);
router.post("/cancelOrder", authMiddleware.authMiddleware, ordercontroller.cancelOrder);
