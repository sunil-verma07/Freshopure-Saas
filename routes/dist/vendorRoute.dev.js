...
router.post("/getallordersbyhotel", authMiddleware.authMiddleware, vendorcontroller.getAllOrdersbyHotel);
router.post("/generatePdf", authMiddleware.authMiddleware, vendorcontroller.generateInvoice);
router.post("/updateStock", authMiddleware.authMiddleware, vendorcontroller.updateStock);
router.post("/addStock", authMiddleware.authMiddleware, vendorcontroller.addItemToStock);
router.get("/getVendorStocks", authMiddleware.authMiddleware, vendorcontroller.getVendorStocks);
router.post("/deleteItemStock", authMiddleware.authMiddleware, vendorcontroller.deleteItemFromStock);
router.post("/deleteHotelItem", authMiddleware.authMiddleware, vendorcontroller.deleteHotelItem);
router.post("/addHotelItem", authMiddleware.authMiddleware, vendorcontroller.addHotelItem);
router.post("/gethotelAssignableItems", authMiddleware.authMiddleware, vendorcontroller.getHotelAssignableItems);
...
router.post("/orderAnalytics", authMiddleware.authMiddleware, vendorcontroller.getVendorOrderAnalytics);
router.get("/itemsForVendor", authMiddleware.authMiddleware, vendorcontroller.itemsForVendor);
router.post("/setVendorItemPrice", authMiddleware.authMiddleware, vendorcontroller.setVendorItemPrice);
router.post("/removeVendorItem", authMiddleware.authMiddleware, vendorcontroller.removeVendorItem);
router.post("/updateItemProfit", authMiddleware.authMiddleware, vendorcontroller.updateHotelItemProfit);
...
router.post("/totalSales", authMiddleware.authMiddleware, vendorcontroller.totalSales);
router.post("/StatusToDelivered", authMiddleware.authMiddleware, vendorcontroller.statusUpdateToDelivered);
router.post("/importAssignedItems", authMiddleware.authMiddleware, vendorcontroller.importAssignedItems);
router.post("/updatePrice", authMiddleware.authMiddleware, vendorcontroller.updatePrice);
router.post("/changeHotelType", authMiddleware.authMiddleware, vendorcontroller.changeHotelType); // // router.get("/getcartitems", authMiddleware.authMiddleware,authMiddleware.profileComplete , cartcontroller.getCartItems)
